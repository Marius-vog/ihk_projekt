...
class LabelImagePage extends StatefulWidget {
  static String routeName = "/labelImage";
  LabelImagePage({Key key}) : super(key: key);

  @override
  _LabelImagePageState createState() => _LabelImagePageState();
}

class _LabelImagePageState extends State<LabelImagePage> {
  File _image;
                  ...
                  ? Column(
                      children: [
                        Padding(
                          ...
                          child: Text(
                            "With this application you can get a list of labels that are associated with the image that you upload.",
                            style: TextStyle(
              ...
              return Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: data.labels != null
                        ? Wrap(
                            spacing: 9,
                            runSpacing: 4,
                            alignment: WrapAlignment.center,
                            children: List<Widget>.generate(data.labels.length,
                                (index) {
                              return Chip(
                                label: Text(
                                  data.labels[index],
                        ...
                        : Text(
                            "There are no labels to be detected",
                            style: TextStyle(
